    ...
    <div class="container-fluid col-xl-12 bg-secondary">
                        ...
                        <li class="nav-item dropdown mx-5">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                               <a class="dropdown-item" href="../estoque/index.php">Estoque</a>
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="index.php">Vendas</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown  mx-5 ">
        ...
        <div class="row bg-white mx-5 px-5  my-1 col-lg-11 rounded-sm " style="height: 570px; ">
            ...
            <form class="my-3 mx-auto col-lg-6">
                ...
                <h4 class=" font-weight-light py-3 pl-5 bd-title text-center ">Cadastro do vendas</h4>

                <div class="form-row">

                    <div class="form-group col-lg-4">
                    <label for="exampleInputText1">Código de venda</label>
                    <input type="text" class="form-control" id="exampleInputEmail1">
                    </div>

                    <div class="form-group col-lg-4">
                    <label for="exampleInputText1">Código de produto</label>
                    <input type="text" class="form-control" id="exampleInputEmail1">
                    </div>
                    ...
                    <div class="form-group col-lg-4  ">
                    <label for="exampleInputNum1">Preço unitário</label>
                    <input type="number" class="form-control" id="exampleInputPassword1">
                    </div>
              
                    <div class="form-group col-lg-4">
                    <label for="exampleInputNum1">Preço final</label>
                    <input type="number" class="form-control" id="exampleInputPassword1">
                    </div>

                    <div class="form-group col-lg-4">
                    <label for="exampleInputNum1">Data da venda</label>
                    <input type="date" class="form-control" id="exampleInputPassword1">
                    </div>

                    <div class="form-group col-lg-12">
                    <label for="exampleInputNum1">CPF</label>
